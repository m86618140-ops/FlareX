...
export const botConfig = {
  ...
  presence: {
    ...
    activities: [
      {
        name: "FlareX, Made by Diuox", // required by Discord API, not shown in the client
        state: "FlareX, Made by Diuox",     // this is what people actually see
        type: 4,               // Custom
      },
    ],
  },
